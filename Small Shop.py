...
"""
This activity was the first one that I got stuck when I started learning Python. At the time, in my first Python bootcamp, I wasn't able to finish this exercise without help from chatGPT, the teachers or even other students that were more advanced in Python. 

This is the first project that made me proud cause it was something that I thought it was impossible to do.

It took me four days to to finish, considering what I know in July of 2023. Four days to figure out the logic and how to apply using Python coding. 
"""
...
#importing "datetime" library to get time and use it in our "greetings function"
import datetime 
